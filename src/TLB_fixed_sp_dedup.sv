...
always_ff@(posedge clk /*or posedge rst*/) begin
    if (rst) begin
        ...
        // FIXED+: Strengthen duplicate suppression for superpage refill.
        if (IN_pw.valid && !ignoreCur &&
            ...
            // Keep duplicate-detection rule aligned with lookup hit rule:
            // - normal page: full VPN match
            // - superpage  : top VPN bits match (same superpage region)
            already_exists = 1'b0;
            ...
            // Only insert if VPN doesn't already exist
